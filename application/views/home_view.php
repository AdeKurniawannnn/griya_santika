<link rel="stylesheet" type="text/css" href="<?= base_url() . 'assets/css/styles.css' ?>" media="all" />
<!-- Banner image -->
<div class="masthead">
	...
	<div class="flexslider">
		<ul class="slides">
			<?php foreach ($result as $row) { ?>
				<li>
					<a href="javascript:;"><img src="<?= site_url('images/slider/' . $row['image']); ?>" alt="<?= $row['title'] ?>" /></a>
