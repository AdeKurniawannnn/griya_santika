...
<div class="container-fluid">
    ...
    <p class="mb-4">Mohon mengisi data Slider dengan benar.</p>
        ...
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Showing Your Slider</h6>
                </div>
                <div class="card-body">
                    <form class="user" method="post" enctype="multipart/form-data" action="<?php echo base_url() . 'slider/add'; ?>">
                        <?php echo $this->session->userdata('message'); ?>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <small class="text-primary font-weight-bold">Title</small>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <small class="text-primary font-weight-bold">Image</small>
                                <input type="file" class="file" id="file" name="image" onchange="return fileValidation()" required>
