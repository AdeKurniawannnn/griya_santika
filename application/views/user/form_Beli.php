...
<body>
    <div class="form_beli" style="background-color:#DEB887 ;">
        <center>
            ...
            <form class="col-sm-6 text-center" method="post" action="<?php echo base_url() . 'order/insert'; ?>" required="required">
                ...
                <tr>
                    <td colspan="3" class="col-sm-12 text-center"><br><br>
                        ...
                        <button type="submit" class="btn btn-primary btn-kirim" href=" <?php echo base_url() . 'booking/cetak/' . $this->session->userdata('id_user'); ?>"><i class="fa fa-print" style="font-size:14px">Cetak</i></button>
                    </td>
                </tr>
            </form>
        </center>
